        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group>
              ...
              <Form.Control type="text" value={tags.join(',')} onChange={handleTagChange} />
            </Form.Group>
            ...
            <Form.Group>
              ...
              <Form.Control type="file" onChange={(e) => handleImageUpload(e, setBannerImage)} />
            </Form.Group>

            <Form.Group>
              <Form.Label>Profile Image</Form.Label>
              <Form.Control type="file" onChange={(e) => handleImageUpload(e, setProfileImage)} />
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
