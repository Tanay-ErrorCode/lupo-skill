...
const dummyArticles = [
  {
    ...
    description: 'Introduction Artificial Intelligence (AI) is revolutionizing the way we interact with technology. From virtual assistants to predictive...',
    readTime: '2 min read',
    clapCount: 10,
    commentCount: 5,
  ...
  },
  {
    ...
    publicationDate: new Date(),
    description: 'Learn the basics of game development and start creating your own games. This guide will walk you through the essential steps...',
    readTime: '3 min read',
    clapCount: 20,
    commentCount: 15,
...
const ArticlesHomepage = () => {
  return (
    <div className='ariclehomepage-div'>
      ...
      <h1>Articles</h1>
      <Link to="/article/write" className="create-article-button">Create Article</Link>
      </div>
      <div className="articles-container">
        {dummyArticles.map(article => (
          <div key={article.id} className="article-card">
            <div className="author-section">
              <img src={article.authorProfileImage} alt={article.authorName} className="author-image" />
              <div>
